...
define('WEBTANAN_BOOKING_VERSION', '1.4.5');
...
require_once WEBTANAN_BOOKING_PATH . 'includes/class-sidebar-menu.php';
...
require_once WEBTANAN_BOOKING_PATH . 'includes/class-patient-profile.php';
